 ...
 * MProductsFixture
 */
class MProductsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        'id' => ['type' => 'biginteger', 'length' => 20, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => '製造種別ID', 'autoIncrement' => true, 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'delete_flag' => 1,
                'm_user_id' => 1,
                'created' => '2019-04-16 14:54:59',
                'modified' => '2019-04-16 14:54:59'
            ],
        ];
        parent::init();
    }
