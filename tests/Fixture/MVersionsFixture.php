 ...
 * MVersionsFixture
 */
class MVersionsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        'id' => ['type' => 'biginteger', 'length' => 20, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => 'バージョン種別ID', 'autoIncrement' => true, 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'delete_flag' => 1,
                'm_user_id' => 1,
                'created' => '2019-04-16 14:55:30',
                'modified' => '2019-04-16 14:55:30'
            ],
        ];
        parent::init();
    }
