...
class MDepartmentsFixture extends TestFixture
{
    ...
    public $fields = [
        'id' => ['type' => 'biginteger', 'length' => 20, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => '部署ID', 'autoIncrement' => true, 'precision' => null],
        'name' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '名称', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'sort' => 1,
                'created' => '2019-04-17 14:24:56',
                'modified' => '2019-04-17 14:24:56'
            ],
        ];
        parent::init();
    }
