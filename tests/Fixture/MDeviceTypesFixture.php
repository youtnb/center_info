 ...
 * MDeviceTypesFixture
 */
class MDeviceTypesFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        'id' => ['type' => 'biginteger', 'length' => 20, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => '端末種別ID', 'autoIncrement' => true, 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'delete_flag' => 1,
                'm_user_id' => 1,
                'created' => '2019-04-16 14:54:38',
                'modified' => '2019-04-16 14:54:38'
            ],
        ];
        parent::init();
    }
