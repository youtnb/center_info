...
class MAreasFixture extends TestFixture
{
    ...
    public $fields = [
        'id' => ['type' => 'biginteger', 'length' => 20, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => '地域ID', 'autoIncrement' => true, 'precision' => null],
        'name' => ['type' => 'string', 'length' => 20, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '地域名', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'delete_flag' => 1,
                'created' => '2019-04-16 14:54:19',
                'modified' => '2019-04-16 14:54:19'
            ],
        ];
        parent::init();
    }
