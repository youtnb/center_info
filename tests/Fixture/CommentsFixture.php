...
class CommentsFixture extends TestFixture
{
    ...
    public $fields = [
        'id' => ['type' => 'biginteger', 'length' => 20, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => 'コメントID', 'autoIncrement' => true, 'precision' => null],
        ...
        '_indexes' => [
            'idx_device' => ['type' => 'index', 'columns' => ['device_id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'delete_flag' => 1,
                'm_user_id' => 1,
                'created' => '2019-04-16 14:55:49',
                'modified' => '2019-04-16 14:55:49'
            ],
        ];
        parent::init();
    }
