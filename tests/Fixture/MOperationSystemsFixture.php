...
/**
 * MOperationSystemsFixture
 */
class MOperationSystemsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        'id' => ['type' => 'biginteger', 'length' => 20, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => 'OS種別ID', 'autoIncrement' => true, 'precision' => null],
        'name' => ['type' => 'string', 'length' => 20, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '名称', 'precision' => null, 'fixed' => null],
        'server_flag' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => '0', 'comment' => 'サーバーOSフラグ', 'precision' => null],
        ...
        '_indexes' => [
            'idx_server_flag' => ['type' => 'index', 'columns' => ['server_flag'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'delete_flag' => 1,
                'm_user_id' => 1,
                'created' => '2019-04-16 14:54:49',
                'modified' => '2019-04-16 14:54:49'
            ],
        ];
        parent::init();
    }
