...
<div class="mProducts view large-9 medium-8 columns content">
    <h3><?= h($mProduct->name) ?></h3>
    <table class="vertical-table">
        ...
        <tr>
            ...
            <td><?= $mProduct->delete_flag ? __('Yes') : __('No'); ?></td>
        </tr>
    </table>
    <div class="related">
        <h4><?= __('Related Devices') ?></h4>
        <?php if (!empty($mProduct->devices)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($mProduct->devices as $devices): ?>
            <tr>
                <td><?= h($devices->id) ?></td>
