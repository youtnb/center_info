...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit M Version'), ['action' => 'edit', $mVersion->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete M Version'), ['action' => 'delete', $mVersion->id], ['confirm' => __('Are you sure you want to delete # {0}?', $mVersion->id)]) ?> </li>
        <li><?= $this->Html->link(__('List M Versions'), ['action' => 'index']) ?> </li>
        <li><?= $this->Html->link(__('New M Version'), ['action' => 'add']) ?> </li>
...
<div class="mVersions view large-9 medium-8 columns content">
    <h3><?= h($mVersion->name) ?></h3>
    <table class="vertical-table">
        ...
        <tr>
            ...
            <td><?= $mVersion->delete_flag ? __('Yes') : __('No'); ?></td>
        </tr>
    </table>
    <div class="related">
        <h4><?= __('Related Devices') ?></h4>
        <?php if (!empty($mVersion->devices)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($mVersion->devices as $devices): ?>
            <tr>
                <td><?= h($devices->id) ?></td>
