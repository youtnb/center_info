    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $comment->has('device') ? $this->Html->link($comment->device->name, ['controller' => 'Devices', 'action' => 'view', $comment->device->id]) : '' ?></td>
                <td><?= h($comment->delete_flag) ?></td>
                <td><?= $comment->has('m_user') ? $this->Html->link($comment->m_user->name, ['controller' => 'MUsers', 'action' => 'view', $comment->m_user->id]) : '' ?></td>
